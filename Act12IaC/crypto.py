...
def desencriptar(texto_cifrado, key, iv):
    ...
    texto_desncriptado = texto_desencriptado_con_padding[: -padding_length]
    return texto_desncriptado.decode('utf-8')

# --- Uso ---
# 1. Generar clave y IV (normalmente, se gurada para su uso posterior)
key, iv = generar_calve_y_iv()
...
texto_desncriptado = desencriptar(texto_encriptado, key, iv)
print(f"Texto desencriptado: {texto_desncriptado}")
